...
async function sendRequest() {
  ...
  const data = await platforms_search(activeIds_company);
...
function editItem(id) {
  ...
  form.value = platform
  form.value.startDate = platform.startDate.slice(0, 16); // "2026-02-14T18:20"
  form.value.endDate = platform.endDate ? platform.endDate.slice(0, 16) : null;
  form_id.value = id
}
        ...
        <form @submit.prevent="submitForm">
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <input v-model="form.address" type="text" class="form-control" required maxlength="75"/>
            </div>
